    ...
    class VideoSearchRepository < ApplicationRepository
      class << self
        def all(part: "id,snippet", order: "date", page_token: nil, published_after: nil, published_before: nil)
          videos = client.list_searches(part, type: "video", max_results: 50, order: order, region_code: "JP", page_token: page_token, published_after: published_after, published_before: published_before, location: "140.526666,35.224144", location_radius: "1000km")
